...
<head>
    ...
    <style>
        ...
        .day { border-bottom: 1px solid #cbd8ea; border-top: 1px solid #cbd8ea; margin-top: 18px; page-break-inside: auto; }
        .day.first-day { margin-top: 0; }
        .day-header { background: #f3f7fb; border-bottom: 1px solid #cbd8ea; padding: 12px 14px; page-break-after: avoid; page-break-inside: avoid; }

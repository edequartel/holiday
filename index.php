    ...
    <div class="page-body"><div class="container-xl"><div class="row row-cards">
        ...
        <?php else: ?>
            ...
            <div class="card mb-3"><div class="card-header"><h3 class="card-title"><i class="ti ti-calendar-event me-2"></i>Itinerary</h3></div><div class="list-group list-group-flush itinerary-card-list">
                <?php foreach ($days as $d): $hasDocuments = !empty($documentsByDay[(int)$d['id']]); ?><div id="day-<?= (int)$d['id'] ?>" class="list-group-item itinerary-day"><div class="row g-2"><div class="col-12 col-md"><div class="itinerary-day-title"><?= h($d['day_date']) ?> · <?= h($d['title']) ?></div><div class="text-secondary"><?= h($d['location']) ?></div><?php if (!$hasDocuments && trim((string)$d['details']) !== ''): ?><p class="mt-2"><?= nl2br(h($d['details'])) ?></p><?php endif; ?><div class="itinerary-badges"><?php if (trim((string)$d['transport']) !== ''): ?><span class="badge transport-badge">Transport: <?= h($d['transport']) ?></span><?php endif; ?><?php if (trim((string)$d['hotel']) !== ''): ?><span class="badge bg-green-lt">Hotel: <?= h($d['hotel']) ?></span><?php endif; ?><?php if (!empty($d['url'])): ?><a class="badge bg-purple-lt text-decoration-none" href="<?= h($d['url']) ?>" target="_blank" rel="noopener">URL</a><?php endif; ?></div>
